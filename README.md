# Elemntor Advanced Widgets Sample Plugin
...
index.php
elementor-advanced-widgets.php
plugin.php
```
...
* `elementor-advanced-widgets.php`	- Main plugin file, used as a loader if plugin minimum requirements are met.
